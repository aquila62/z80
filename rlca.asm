; rlca.asm - Test rotate left with carry   Version 1.0.0
...
;------------------------------------------------------------
; This program illustrates the rlca instruction
...
kcout: equ 0009h       ; CP/M branch vector for console  output
   ...
   ld a,01h            ; initialize the A register
...
lp:                        ; loop based on keyboard input
   ...
   rlca                    ; rotate A to the left with carry
